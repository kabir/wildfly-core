...
class ComplexRuntimeAttributesExtension implements Extension {
    ...
    private static final AttributeDefinition TWO_RUNTIME = new SimpleAttributeDefinitionBuilder("two", ModelType.LONG)
            .setUndefinedMetricValue(ModelNode.ZERO)
            .setFlags(AttributeAccess.Flag.STORAGE_RUNTIME, AttributeAccess.Flag.COUNTER_METRIC)
            .build();

    private static final AttributeDefinition MAP_OF_MAPS = ObjectTypeAttributeDefinition.Builder.of("map-of-maps", ONE_RUNTIME/*, TWO_RUNTIME*/)
            .setRequired(false)
        ...
        ResourceBuilder builder = ResourceBuilder.Factory.create(SUBSYSTEM_PATH, new NonResolvingResourceDescriptionResolver())
                ...
                .addMetric(MAP_OF_MAPS, new OperationStepHandler() {
                    ...
                    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                        ...
                        result.get("a", "one").set(100L);
//                        result.get("a", "two").set(101L);
//                        result.get("b", "one").set(102L);
//                        result.get("b", "two").set(103L);
