...
public class UnstableAnnotationApiService implements Service {

    public static ServiceName SERVICE_NAME = ServiceName.JBOSS.append("core-management", "unstable-annotation-api", "level");
    private final Consumer<UnstableAnnotationApiService> serviceConsumer;
    ...
    public UnstableAnnotationApiService(Consumer<UnstableAnnotationApiService> serviceConsumer, UnstableApiAnnotationLevel level) {
