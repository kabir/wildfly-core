...
import org.jboss.as.server.deployment.annotation.ScanExperimentalAnnotationsProcessors;
...
//        serverExecutorService.getThreadFactoryInjector().inject(threadFactory);
    ...
    protected void boot(final BootContext context) throws ConfigurationPersistenceException {
        ...
        try {
            ...
            DeployerChainAddHandler.addDeploymentProcessor(SERVER_NAME, Phase.PARSE, Phase.PARSE_SCAN_EXPERIMENTAL_ANNOTATIONS, ScanExperimentalAnnotationsProcessors.createProcessor(runningModeControl.getRunningMode()));
