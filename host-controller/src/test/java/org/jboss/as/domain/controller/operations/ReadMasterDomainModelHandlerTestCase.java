...
public class ReadMasterDomainModelHandlerTestCase {
    ...
    private Resource transformResource(TransformerRegistry registry, Resource resourceRoot, ManagementResourceRegistration resourceRegistration, Transformers.ResourceIgnoredTransformationRegistry ignoredTransformationRegistry) throws OperationFailedException {
    ...
    private ResourceTransformationContext createContext(TransformerRegistry registry, Resource resourceRoot, TransformationTarget target, ManagementResourceRegistration resourceRegistration, Transformers.ResourceIgnoredTransformationRegistry ignoredTransformationRegistry) {
        return Transformers.Factory.create(target, resourceRoot, resourceRegistration, ExpressionResolver.TEST_RESOLVER, RunningMode.NORMAL, ProcessType.STANDALONE_SERVER, ignoredTransformationRegistry);
