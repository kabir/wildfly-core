...
public class ProfileIncludesHandlerTestCase extends AbstractOperationTestCase {
    ...
    public void testGoodProfileIncludesAdd() throws Exception {
        ...
        ProfileAddHandler.INSTANCE.execute(getOperationContext(addr), op);
    }
    ...
    public void testGoodProfileIncludesWrite() throws Exception {
        ...
        new ProfileValidationWriteAttributeHandler(ProfileResourceDefinition.INCLUDES).execute(getOperationContext(addr), op);
    }
    ...
    public void testCyclicProfileIncludesWrite() throws Exception {
        ...
        ModelNode op = Util.getWriteAttributeOperation(addr, INCLUDES, list);
        new ProfileValidationWriteAttributeHandler(ProfileResourceDefinition.INCLUDES).execute(getOperationContextWithIncludes(addr), op);
    }
    ...
    public void testGoodProfileIncludesRemove() throws Exception {
        ...
        ProfileRemoveHandler.INSTANCE.execute(getOperationContextWithIncludes(addr), op);
    }
